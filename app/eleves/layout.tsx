            ...
            <div className="min-h-screen bg-[#08080C] text-foreground flex flex-col md:flex-row font-sans relative">
                ...
                <header className="md:hidden sticky top-0 z-50 bg-[#08080C]/90 backdrop-blur-xl border-b border-white/5 flex flex-col shrink-0">
                    ...
                    <div className="p-3 flex justify-between items-center">
                        <div className="font-black tracking-widest text-[#CC0000] text-sm" style={{ fontFamily: "var(--font-oswald, sans-serif)" }}>ÉLÈVES</div>
                ...
                <aside className="w-full md:w-64 bg-[#08080C]/95 backdrop-blur-xl border-r border-white/5 flex flex-col h-auto md:h-screen shrink-0 md:sticky md:top-0 relative z-10">
                    ...
                    <div className="hidden md:flex p-5 border-b border-white/5 items-center justify-between">
                        <div className="font-black tracking-[0.15em] text-white text-lg" style={{ fontFamily: "var(--font-oswald, sans-serif)" }}>ÉLÈVES</div>
                    ...
                    <nav className="flex-1 p-3 flex flex-row md:flex-col gap-1.5 overflow-x-auto md:overflow-hidden hide-scrollbar">
                        {[
                            ...
                            <Link
                                key={link.name}
                                href={link.href}
                                className="flex flex-row items-center gap-3 px-4 py-3 md:py-3.5 rounded-xl text-sm font-medium text-neutral-500 hover:bg-[#CC0000]/10 hover:text-[#CC0000] border border-transparent hover:border-[#CC0000]/20 transition-all whitespace-nowrap md:whitespace-normal shrink-0"
                            >
                    ...
                    <div className="p-4 border-t border-white/5 mt-auto hidden md:block">
                        <div className="bg-[#CC0000]/10 border border-[#CC0000]/20 rounded-xl p-4">
                            <h3 className="text-[#CC0000] font-black text-xs mb-1 tracking-widest uppercase" style={{ fontFamily: "var(--font-league-spartan, sans-serif)" }}>Session Active</h3>
                            <p className="text-xs text-neutral-600">Connexion anonyme sécurisée.</p>
                        </div>
