            ...
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 text-center md:text-left order-2 md:order-1 z-10">
                ...
                <p className="mx-auto md:mx-0 max-w-xl text-lg md:text-xl text-neutral-soft mb-8 leading-relaxed">
                  L'écosystème numérique de prévention dédié aux jeunes et aux équipes éducatives.
                </p>
                <div className="flex flex-col sm:flex-row items-center md:items-start gap-4 justify-center md:justify-start">
                  <Link href="/eleves" className="w-full sm:w-auto">
                    <Button size="lg" className="w-full text-base gap-2 shadow-[0_0_20px_rgba(239,68,68,0.2)] hover:shadow-[0_0_30px_rgba(239,68,68,0.4)] transition-all">
                      Accès Portail Élèves
                      <ArrowRight className="h-4 w-4" />
                    </Button>
                  </Link>
                  <Link href="/pros" className="w-full sm:w-auto">
                    <Button variant="outline" size="lg" className="w-full text-base gap-2 border-primary/50 text-white hover:bg-primary/20 hover:border-primary transition-all">
                      <Shield className="h-4 w-4 text-primary" />
                      Portail Professionnels
                    </Button>
                  </Link>
                  <Link href="/a-propos" className="w-full sm:w-auto">
                    <Button variant="ghost" size="lg" className="w-full text-base hover:bg-white/5">
